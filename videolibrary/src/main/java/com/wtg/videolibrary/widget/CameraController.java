...
//                StreamConfigurationMap map1 = cameraCharacteristics.get(CameraCharacteristics.SCALER_STREAM_CONFIGURATION_MAP);
//                mPreviewSize = map1.getOptimalSize(map.getOutputSizes(SurfaceTexture.class), width, height);
