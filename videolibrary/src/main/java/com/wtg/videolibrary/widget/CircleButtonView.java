...
public class CircleButtonView extends View {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        mInitBitRadius = mBigRadius = (mWidth / 2.0f) * 0.75f;
    ...
    private void drawProgress(Canvas canvas) {
        ...
        //用于定义的圆弧的形状和大小的界限
        RectF oval = new RectF((mWidth / 2.0f) - (mBigRadius - mProgressW / 2), (mHeight / 2.0f) - (mBigRadius - mProgressW / 2), (mWidth / 2.0f) + (mBigRadius - mProgressW / 2), (mHeight / 2.0f) + (mBigRadius - mProgressW / 2));
        //根据进度画圆弧
